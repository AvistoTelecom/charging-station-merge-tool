...
def test_extract_borne():
    ...
    assert(borne_1_chademo["socket_type_ef"]) == False
    assert(borne_1_chademo["socket_type_2"]) == False
    assert(borne_1_chademo["socket_type_combo_ccs"]) == False
    assert(borne_1_chademo["socket_type_chademo"]) == True
    assert(borne_1_chademo["socket_type_autre"]) == False
    ...
    assert(borne_1_type2["socket_type_ef"]) == False
    assert(borne_1_type2["socket_type_2"]) == True
    assert(borne_1_type2["socket_type_combo_ccs"]) == False
    assert(borne_1_type2["socket_type_chademo"]) == False
    assert(borne_1_type2["socket_type_autre"]) == False
    ...
    assert(borne_2_type2_combo["socket_type_ef"]) == False
    assert(borne_2_type2_combo["socket_type_2"]) == False
    assert(borne_2_type2_combo["socket_type_combo_ccs"]) == True
    assert(borne_2_type2_combo["socket_type_chademo"]) == False
    assert(borne_2_type2_combo["socket_type_autre"]) == False
    ...
    assert(borne_4_type2_combo) == None
